...
function AM40Wordmark() {
  return <span className="text-sm font-bold tracking-tight text-foreground">AM40</span>;
}
                  ...
                  <Collapsible key={status} className="group/collapsible" defaultOpen>
                    <SidebarMenuItem>
                      ...
                      >
                        ...
                        <span
                          className={`size-2 shrink-0 rounded-full ${CONDUCTOR_STATUS_DOT_CLASS[status]}`}
